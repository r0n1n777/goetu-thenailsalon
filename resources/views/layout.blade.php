...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        @endif">
            ...
            <a href="https://salons.go3reservation.com/the-nail-salon-1740-w-adams-ste-3017-phoenix-arizona" target="_blank" class="text-dark text-decoration-none p-3 my-4 book-us-button border-0 rounded" data-aos="fade-right">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary p-3" id="header">
            ...
            <div class="navbar-collapse collapse justify-content-center">
                <ul class="navbar-nav text-center">
                    ...
                    <li class="nav-item px-1">
                        <a class="nav-link" href="https://salons.go3reservation.com/the-nail-salon-1740-w-adams-ste-3017-phoenix-arizona" target="_blank">
